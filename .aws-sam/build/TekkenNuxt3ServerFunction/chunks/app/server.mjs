import { version, useSSRContext, getCurrentInstance, inject, ref, watchEffect, watch, defineComponent, unref, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, hasInjectionContext, toRef, h, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const head_xR53WE0jXG = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1>Counter</h1><p>${ssrInterpolate(unref(counter))}</p><button>Click Me</button></div>`);
    };
  }
});
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-4be2086f.mjs').then((r) => r.default || r));
