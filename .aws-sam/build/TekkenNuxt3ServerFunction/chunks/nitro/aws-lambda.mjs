...
const _lazy_8cqrrY = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_8cqrrY, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8cqrrY, lazy: true, middleware: false, method: undefined }
];
